...
<body>
    ...
    <div class="content1">
		<video class="from1" id="localVideo" autoplay controls></video> 
		<video class="to1" id="remoteVideo" autoplay controls></video>
        <video class="to2" id="remoteVideo" autoplay controls></video>
		<video class="to3" id="remoteVideo" autoplay controls></video>
        <video class="to4" id="remoteVideo" autoplay controls></video>
		<video class="to5" id="remoteVideo" autoplay controls></video>
	</div>
